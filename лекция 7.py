...
# fig, ax = plt.subplots(2, 3, sharex='col', sharey='row') #убрали лишние координаты
...
# plt.subplot(grid[0, 1:]) #до конца заполнение
# plt.subplot(grid[1, 1])
# plt.subplot(grid[1, 2]) #такими приемами можно заполнить рамку как хотим
...
# ax.text('1969-01-01', 5500, "Новый год", **style) #позиция и надпись на графике
...
# ax.annotate('Локальный максимум', xy=(6.28, 1), xytext=(10,4), arrowprops=dict(facecolor='red')) #стрелка
